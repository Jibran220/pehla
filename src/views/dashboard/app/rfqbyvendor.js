...
import { allUsersRoute, host } from "../../dashboard/utils/APIRoutes";
               ...
               <Card>
                  <Card.Header className="d-flex justify-content-between">
                     <div className="header-title">
                        {/* <h4 className="card-title">RFQs List</h4> */}
                     </div>
                  </Card.Header>
...
//   //         console.warn(params)
//   //         let result=await fetch (`${Api}/rfqmanagers/search/"muhammadjibran890@gmail.com"`)
