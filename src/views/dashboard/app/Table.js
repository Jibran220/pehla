      ...
      <table width="100%" className="mb-10">
        <thead>
          <tr className="bg-gray-100 p-1">
            <td className="font-bold"> <h3>Description</h3></td>
            <td className="font-bold"><h3> Quantity</h3></td>
            <td className="font-bold"><h3> Price</h3></td>
            <td className="font-bold"><h3> Amount</h3></td>
          </tr>
        </thead>
        {list.map(({ id, description, quantity, price, amount,heading }) => (
          <React.Fragment key={id}>
            <tbody>
              <tr className="h-10">
              <td><u><h5> <b>{heading}:</b></h5>  </u><br/><p><i>{description}</i></p></td>
                <td>{quantity}</td>
                <td>{price}</td>
                <td>{amount}</td>
              </tr>
